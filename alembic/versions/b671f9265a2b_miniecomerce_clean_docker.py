"""miniecomerce clean docker

Revision ID: b671f9265a2b
Revises: 
Create Date: 2022-01-14 12:40:08.963170
...
def upgrade():
    ...
    sa.Column('neghbourhood', sa.String(length=45), nullable=True),
